...
var challenges = {
            math: [
                ...
                { question: "כמה זה <span class='math-expression'>63 + 29</span>?", options: ["92", "82", "102", "88"], correct: 2 },
                { question: "מה התוצאה של <span class='math-expression'>96 ÷ 12</span>?", options: ["8", "6", "10", "7"], correct: 0 },
                { question: "איזה מספר חסר ברצף?<div class='math-expression'>1, 4, 9, 16, ?</div>", options: ["20", "25", "21", "24"], correct: 3 },
                { question: "מה שווה <span class='math-expression'>5/8</span> של <span class='math-expression'>24</span>?", options: ["15", "12", "18", "20"], correct: 0 },
                { question: "כמה זה <span class='math-expression'>14 × 6</span>?", options: ["84", "74", "94", "64"], correct: 1 },
                { question: "מה התוצאה של <span class='math-expression'>180 - 95</span>?", options: ["85", "75", "95", "80"], correct: 3 },
                { question: "כמה זה <span class='math-expression'>56 ÷ 7</span>?", options: ["8", "7", "9", "6"], correct: 2 },
                ...
                { question: "כמה זה <span class='math-expression'>77 + 35</span>?", options: ["112", "102", "122", "108"], correct: 3 },
                ...
                { question: "מה שווה <span class='math-expression'>3/5 + 1/10</span>?", options: ["4/15", "7/10", "2/5", "1/2"], correct: 3 },
                { question: "כמה זה <span class='math-expression'>19 × 4</span>?", options: ["76", "84", "68", "72"], correct: 2 }
            ],
            english: [
            ...
            logic: [
                ...
                { question: "בבית ספר שלוש קומות. הכיתה של יעל מעל זו של דני ומתחת לזו של מיכל. באיזו קומה דני?", options: ["ראשונה", "שנייה", "שלישית", "רביעית"], correct: 2 },
                { question: "מהו המספר הבא בסדרת פיבונאצ'י: 1, 1, 2, 3, 5, 8, ?", options: ["11", "12", "13", "14"], correct: 2 },
                { question: "שני אבות ושני בנים יצאו לדוג ותפסו שלושה דגים, וכל אחד קיבל דג. איך זה אפשרי?", options: ["היו שלושה דורות: סבא, אבא ובן", "היו שני אנשים בלבד", "אחד לא קיבל דג", "דג אחד היה כפול"], correct: 3 },
                ...
                { question: "בקובייה סטנדרטית הספרה 1 מול 6 ו‑2 מול 5. מול איזו ספרה נמצאת הספרה 3?", options: ["4", "5", "6", "1"], correct: 1 },
